...
-- Serial relations have to be an endorelator to the original domain set.
-- To check this we test if the 2-length pairs generated by the subsequences of the domain are serial to the domain, which they should be.
